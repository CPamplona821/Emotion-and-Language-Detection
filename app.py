...
# Load Model
import joblib 
pipe_lr1 = joblib.load(open("./models/emotion_classifier_pipe_lr.pkl","rb"))
pipe_lr2 = joblib.load(open("./models/svm.pkl","rb"))
...
def main():
	...
	if choice == "Home":
		...
		if submit_text:
			...
			emotion_prediction = predict_emotions(raw_text, emotion_prediction_model)
			emotion_probability = get_prediction_proba(raw_text, emotion_prediction_model)

			language_prediction_model = pipe_lr2
			language_prediction = predict_emotions(raw_text, language_prediction_model)
			language_probability = get_prediction_proba(raw_text, language_prediction_model)
			...
			with col3:
				...
				emoji_icon = emotions_emoji_dict[emotion_prediction]
